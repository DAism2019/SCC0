...
**Smart Creative Commons Zero (SCC0)** is not only the first public goods license designed for public decentralized applications (which is named "Smart Commons"), which includes dApps<a href="#r5"><sup>[5]</sup></a> and dAIpps, but also the first license which could be verified and self-governed when a smart common interacting with another one. Importantly, a Smart Common must be open source and free for the public (except for gas fees).
