...
为了便于区别治理，我们把其内核为 AI 的去中心化应用称为 dAIpp，完全由智能合约主导的去中心化应用则为 dApp。
...
以上是现有的策略，对于AI，可预期的未来的治理策略为：
不得违背人类新文明的基础伦理——只有 AI 遵循人类新文明的基础伦理，它才能被安全地被使用。
